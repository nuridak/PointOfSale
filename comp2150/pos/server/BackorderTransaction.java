/**
 * BackorderTransaction
 *
 * @author Nurida Karimbaeva, 7851221
 *
 * REMARKS: This class extends Transaction class, and creates an instances of the Backorder Transaction
 *
 */
package comp2150.pos.server;
import java.util.LinkedList;

public class BackorderTransaction extends Transaction{
    ...
    //
    public BackorderTransaction(A5POSServer.TransactionType type, long time, int client){
        super(type, time, client);
        idOfTransaction="B"+idNumber;
