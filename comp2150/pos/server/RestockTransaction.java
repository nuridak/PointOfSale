 ...
 *
 * REMARKS: This class extends Transaction class, and creates an instances of the Restock Transaction
 *
 */
package comp2150.pos.server;
import java.util.LinkedList;

public class RestockTransaction extends Transaction {
    ...
    //
    public RestockTransaction(A5POSServer.TransactionType type, long time, int client){
        super(type, time, client);
        idOfTransaction="Restock"+idNumber;
